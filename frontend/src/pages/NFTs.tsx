...
import { 
  Moon, Star, Shield, Crown, Sparkles, Brain, 
  BedDouble, Zap, Target, Trophy, Clock, Loader2,
  CheckCircle, ZapIcon 
} from 'lucide-react';
...
const nfts: NFTCard[] = [
  {
    ...
    description: "Your entry-level booster—mint it and start benefiting right away!",
  ...
  },
  {
    ...
    description: "Adjusts to your unique sleep cycle for optimized performance.",
    requirements: "Meet personalized sleep goals",
    effects: ["5% bonus when hitting targeted sleep performance"],
    color: {
      bg: "bg-green-50",
      text: "text-green-600",
  ...
  },
  {
    ...
    requirements: "Achieve 8 hours of sleep for 3 consecutive nights",
    effects: [
  ...
  },
  {
    ...
    requirements: "Achieve optimal sleep quality with consistent REM cycles",
    effects: [
  ...
  },
  {
    ...
    requirements: "Maintain 90%+ sleep score for 7 consecutive days",
    effects: [
  ...
  },
  {
    ...
    requirements: "7-8 hours of high-quality sleep for 10 consecutive days",
    effects: [
  ...
  },
  {
    ...
    requirements: "Consistently achieve high sleep scores over time",
    effects: [
              ...
              {isMinting ? (
                <>
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-xl font-bold text-night-900 mb-2">Minting Dream Weaver NFT</h2>
                    <p className="text-night-600">Please wait while we mint your NFT...</p>
                  </div>
                ...
                <div className="text-center">
                  ...
                  <h2 className="text-2xl font-bold text-night-900 mb-4">Minting Complete!</h2>
                  <p className="text-night-600 mb-6">
                    Your Dream Weaver NFT has been successfully minted. You can now start earning boosted rewards!
                  </p>
                  <button
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-night-600 text-lg max-w-2xl mx-auto">
              Transform your sleep habits into digital assets. Each NFT provides unique benefits and boosts to your sleep-to-earn rewards.
            </p>
          </div>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className={`p-2 ${nft.color.bg} rounded-xl`}>
                        <div className={nft.color.icon}>
                          {nft.icon}
                        </div>
                      </div>
                      <div>
                        <h3 className="text-lg font-bold text-night-900">{nft.name}</h3>
                        <div className={`inline-flex items-center gap-1 px-2 py-0.5 text-xs font-medium rounded-full ${nft.color.bg} ${nft.color.text} border ${nft.color.border}`}>
                          {nft.rarity}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-night-700">Requirements</span>
                    </div>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-night-700">Effects</span>
                    </div>
                    <ul className="space-y-2">
                      {nft.effects.map((effect, index) => (
                        <li key={index} className="flex items-start gap-2 text-sm text-night-600">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg ring-1 ring-primary-100 mt-12">
            <h2 className="text-2xl font-bold text-night-900 mb-6 font-display">How It Works</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-night-600">
                  Get started with the Dream Weaver NFT or earn higher-tier NFTs through consistent sleep performance.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-night-600">
                  Use our integrated sleep tracking system to monitor your progress and achieve your goals.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-night-600">
                  Earn increased rewards based on your NFTs and sleep performance metrics.
                </p>
              </div>
            </div>
          </div>
...
function MintingStep({ step, currentStep, title, description }: { 
  step: number; 
  currentStep: number; 
  title: string; 
  description: string; 
