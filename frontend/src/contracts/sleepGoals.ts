...
export const SLEEP_GOALS_ABI = [
  ...
  "function getUserGoal(address _user) external view returns (uint256 bedtime, uint256 wakeTime, uint256 duration, uint256 quality, uint256 depositAmount, bool achieved, uint256 goalDuration, string mode)",
...
export const SLEEP_GOALS_ADDRESS = "0xc3418F06044c455beD8d25634E2ceD2b777c1fA0";
